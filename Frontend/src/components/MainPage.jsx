  ...
  const workExperiences = [
    {
      ...
      description:
        "Developed a To Do List application with an automated scheduling feature, built a photo management application named Phoof, and created a digital assistance tool for emergency situations, contributing to application flow and user interface design.",
    },
    {
